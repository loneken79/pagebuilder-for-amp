<?php
if(class_exists('ET_Builder_Module_Fullwidth_Slider')){
class AMP_ET_Builder_Module_Fullwidth_Slider extends ET_Builder_Module {
	function init() {
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		//echo get_stylesheet_directory_uri() . '/style' . $style_suffix . '.css';
		//die;
...
$fullwidthSliderObj = new AMP_ET_Builder_Module_Fullwidth_Slider;
remove_shortcode( 'et_pb_fullwidth_slider' );
add_shortcode( 'et_pb_fullwidth_slider', array($fullwidthSliderObj, '_render'));
}