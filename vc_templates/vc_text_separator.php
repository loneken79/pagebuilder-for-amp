 ...
 */
global $amp_vc_elements_atts, $custom_inlinecss;
...
$inline_css = ( 'custom' === $color && '' !== $accent_color ) ? ' ' . vc_get_css_color( 'border-color', $accent_color ) .'' : '';
$newClass ='';
if($inline_css){
	$newClass  = 'vc_il_'.substr(time().str_shuffle(md5(time())),-4,4);
	
	$custom_inlinecss['text_separator'] .= ".".$newClass."{".$inline_css.'}';
}
...
<div class="$css_class txt-sep" $wrapper_attributes_html><span class="vc_sep_holder vc_sep_holder_l"><span  class="vc_sep_line $newClass"></span></span>$content<span class="vc_sep_holder vc_sep_holder_r"><span  class="vc_sep_line $newClass"></span></span>
</div>
TEMPLATE;
echo $separatorHtml;
