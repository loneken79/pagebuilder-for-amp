...
$amp_vc_elements_atts[$shortcode_slug] = $attributes;
...
if ( 'nivo' === $type ) {
	...
	//$slides_wrap_end = '</ul>';
	$slides_wrap_start = '<amp-carousel lightbox width="400" height="300" layout="responsive" type="slides">';
	$slides_wrap_end = '</amp-carousel';
